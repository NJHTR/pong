...
| Native macOS | FAIL | GitHub Actions runs `33074865773` and `33080915116`, artifact `m1-macos-native-evidence` | macOS 14 arm64 / APFS / Rust 1.98 + 1.78 | Run #1 had platform-inapplicable test compilation; run #2 failed MSRV test (`101`) while MSRV clippy exited `0`, and omitted platform metadata, manifest, and stable logs; complete rerun required |
